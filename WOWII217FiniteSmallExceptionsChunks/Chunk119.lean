...
theorem connected_degreeSequence_33321_closure_chain :
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_33321_closes :
    ∀ g : BitVec 10,
      connectedUpper (n := 5) g = true →
      fixedDegreeSequenceUpper (n := 5) g
        [3, 3, 3, 2, 1] = true →
  ...
  have closed := connected_degreeSequence_33321_closure_chain g g1 g2 g3 g4 connected degrees
