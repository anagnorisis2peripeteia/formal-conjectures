...
theorem connected_degreeSequence_2211_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 6,
      connectedUpper (n := 4) g = true →
      fixedDegreeSequenceUpper (n := 4) g
        [2, 2, 1, 1] = true →
      (g1 == pathClosureParallelRound (n := 4) g) = true →
      (g2 == pathClosureParallelRound (n := 4) g1) = true →
      (g3 == pathClosureParallelRound (n := 4) g2) = true →
      (g4 == pathClosureParallelRound (n := 4) g3) = true →
      completeUpper (n := 4) g4 = true := by
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_2211_closes :
    ∀ g : BitVec 6,
      connectedUpper (n := 4) g = true →
      fixedDegreeSequenceUpper (n := 4) g
        [2, 2, 1, 1] = true →
  ...
  let g1 := pathClosureParallelRound (n := 4) g
  let g2 := pathClosureParallelRound (n := 4) g1
  let g3 := pathClosureParallelRound (n := 4) g2
  let g4 := pathClosureParallelRound (n := 4) g3
  have closed := connected_degreeSequence_2211_closes_closure_chain g g1 g2 g3 g4 connected degrees
