...
theorem connected_degreeSequence_666444444_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 36,
      connectedUpper (n := 9) g = true →
      fixedDegreeSequenceUpper (n := 9) g
        [6, 6, 6, 4, 4, 4, 4, 4, 4] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_666444444_closes :
    ∀ g : BitVec 36,
      connectedUpper (n := 9) g = true →
      fixedDegreeSequenceUpper (n := 9) g
        [6, 6, 6, 4, 4, 4, 4, 4, 4] = true →
  ...
  have closed := connected_degreeSequence_666444444_closure_chain g g1 g2 g3 g4 connected degrees
