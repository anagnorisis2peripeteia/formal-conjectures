...
theorem connected_degreeSequence_333311_closes_closure_chain :
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_333311_closes :
    ∀ g : BitVec 15,
      connectedUpper (n := 6) g = true →
      fixedDegreeSequenceUpper (n := 6) g
        [3, 3, 3, 3, 1, 1] = true →
  ...
  have closed := connected_degreeSequence_333311_closes_closure_chain g g1 g2 g3 g4 connected degrees
