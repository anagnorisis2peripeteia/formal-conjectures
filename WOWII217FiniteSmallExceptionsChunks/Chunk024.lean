...
theorem connected_degreeSequence_55553333_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 28,
      connectedUpper (n := 8) g = true →
      fixedDegreeSequenceUpper (n := 8) g
        [5, 5, 5, 5, 3, 3, 3, 3] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_55553333_closes :
    ∀ g : BitVec 28,
      connectedUpper (n := 8) g = true →
      fixedDegreeSequenceUpper (n := 8) g
        [5, 5, 5, 5, 3, 3, 3, 3] = true →
  ...
  have closed := connected_degreeSequence_55553333_closes_closure_chain g g1 g2 g3 g4 connected degrees
