...
theorem connected_degreeSequence_3221_closure_chain :
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_3221_closes :
    ∀ g : BitVec 6,
      connectedUpper (n := 4) g = true →
      fixedDegreeSequenceUpper (n := 4) g
        [3, 2, 2, 1] = true →
  ...
  have closed := connected_degreeSequence_3221_closure_chain g g1 g2 g3 g4 connected degrees
