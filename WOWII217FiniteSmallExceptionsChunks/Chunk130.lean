...
theorem connected_degreeSequence_6444422_closure_chain :
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_6444422_closes :
    ∀ g : BitVec 21,
      connectedUpper (n := 7) g = true →
      fixedDegreeSequenceUpper (n := 7) g
        [6, 4, 4, 4, 4, 2, 2] = true →
  ...
  have closed := connected_degreeSequence_6444422_closure_chain g g1 g2 g3 g4 connected degrees
