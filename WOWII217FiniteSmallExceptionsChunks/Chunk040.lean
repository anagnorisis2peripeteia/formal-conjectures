...
theorem connected_degreeSequence_666665531_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 36,
      connectedUpper (n := 9) g = true →
      fixedDegreeSequenceUpper (n := 9) g
        [6, 6, 6, 6, 6, 5, 5, 3, 1] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_666665531_closes :
    ∀ g : BitVec 36,
      connectedUpper (n := 9) g = true →
      fixedDegreeSequenceUpper (n := 9) g
        [6, 6, 6, 6, 6, 5, 5, 3, 1] = true →
  ...
  have closed := connected_degreeSequence_666665531_closes_closure_chain g g1 g2 g3 g4 connected degrees
