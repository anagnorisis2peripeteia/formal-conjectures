...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_66666651_closes :
    ∀ g : BitVec 28,
      connectedUpper (n := 8) g = true →
      fixedDegreeSequenceUpper (n := 8) g
        [6, 6, 6, 6, 6, 6, 5, 1] = true →
  ...
  have closed := connected_degreeSequence_66666651_closure_chain g g1 g2 g3 g4 connected degrees
