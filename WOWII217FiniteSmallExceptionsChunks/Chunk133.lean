...
theorem connected_degreeSequence_5555541_closure_chain :
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_5555541_closes :
    ∀ g : BitVec 21,
      connectedUpper (n := 7) g = true →
      fixedDegreeSequenceUpper (n := 7) g
        [5, 5, 5, 5, 5, 4, 1] = true →
  ...
  have closed := connected_degreeSequence_5555541_closure_chain g g1 g2 g3 g4 connected degrees
