...
theorem connected_degreeSequence_22211_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 10,
      connectedUpper (n := 5) g = true →
      fixedDegreeSequenceUpper (n := 5) g
        [2, 2, 2, 1, 1] = true →
      (g1 == pathClosureParallelRound (n := 5) g) = true →
      (g2 == pathClosureParallelRound (n := 5) g1) = true →
      (g3 == pathClosureParallelRound (n := 5) g2) = true →
      (g4 == pathClosureParallelRound (n := 5) g3) = true →
      completeUpper (n := 5) g4 = true := by
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_22211_closes :
    ∀ g : BitVec 10,
      connectedUpper (n := 5) g = true →
      fixedDegreeSequenceUpper (n := 5) g
        [2, 2, 2, 1, 1] = true →
  ...
  let g1 := pathClosureParallelRound (n := 5) g
  let g2 := pathClosureParallelRound (n := 5) g1
  let g3 := pathClosureParallelRound (n := 5) g2
  let g4 := pathClosureParallelRound (n := 5) g3
  have closed := connected_degreeSequence_22211_closes_closure_chain g g1 g2 g3 g4 connected degrees
