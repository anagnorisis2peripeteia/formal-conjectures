...
theorem connected_degreeSequence_555544422_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 36,
      connectedUpper (n := 9) g = true →
      fixedDegreeSequenceUpper (n := 9) g
        [5, 5, 5, 5, 4, 4, 4, 2, 2] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_555544422_closes :
    ∀ g : BitVec 36,
      connectedUpper (n := 9) g = true →
      fixedDegreeSequenceUpper (n := 9) g
        [5, 5, 5, 5, 4, 4, 4, 2, 2] = true →
  ...
  have closed := connected_degreeSequence_555544422_closure_chain g g1 g2 g3 g4 connected degrees
