...
theorem connected_degreeSequence_55555544444_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 55,
      connectedUpper (n := 11) g = true →
      fixedDegreeSequenceUpper (n := 11) g
        [5, 5, 5, 5, 5, 5, 4, 4, 4, 4, 4] = true →
      (g1 == pathClosureParallelRound (n := 11) g) = true →
      (g2 == pathClosureParallelRound (n := 11) g1) = true →
      (g3 == pathClosureParallelRound (n := 11) g2) = true →
      (g4 == pathClosureParallelRound (n := 11) g3) = true →
      completeUpper (n := 11) g4 = true := by
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_55555544444_closes :
    ∀ g : BitVec 55,
      connectedUpper (n := 11) g = true →
      fixedDegreeSequenceUpper (n := 11) g
        [5, 5, 5, 5, 5, 5, 4, 4, 4, 4, 4] = true →
      completeUpper (n := 11) (pathClosureParallelRounds (n := 11) 4 g) = true := by
  intro g connected degrees
  let g1 := pathClosureParallelRound (n := 11) g
  let g2 := pathClosureParallelRound (n := 11) g1
  let g3 := pathClosureParallelRound (n := 11) g2
  let g4 := pathClosureParallelRound (n := 11) g3
  have closed := connected_degreeSequence_55555544444_closes_closure_chain g g1 g2 g3 g4 connected degrees
