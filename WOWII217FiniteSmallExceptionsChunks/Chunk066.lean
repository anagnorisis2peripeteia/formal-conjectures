...
theorem connected_degreeSequence_6666554433_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 45,
      connectedUpper (n := 10) g = true →
      fixedDegreeSequenceUpper (n := 10) g
        [6, 6, 6, 6, 5, 5, 4, 4, 3, 3] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_6666554433_closes :
    ∀ g : BitVec 45,
      connectedUpper (n := 10) g = true →
      fixedDegreeSequenceUpper (n := 10) g
        [6, 6, 6, 6, 5, 5, 4, 4, 3, 3] = true →
  ...
  have closed := connected_degreeSequence_6666554433_closes_closure_chain g g1 g2 g3 g4 connected degrees
