...
theorem connected_degreeSequence_666666655543_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 66,
      connectedUpper (n := 12) g = true →
      fixedDegreeSequenceUpper (n := 12) g
        [6, 6, 6, 6, 6, 6, 6, 5, 5, 5, 4, 3] = true →
      (g1 == pathClosureParallelRound (n := 12) g) = true →
      (g2 == pathClosureParallelRound (n := 12) g1) = true →
      (g3 == pathClosureParallelRound (n := 12) g2) = true →
      (g4 == pathClosureParallelRound (n := 12) g3) = true →
      completeUpper (n := 12) g4 = true := by
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_666666655543_closes :
    ∀ g : BitVec 66,
      connectedUpper (n := 12) g = true →
      fixedDegreeSequenceUpper (n := 12) g
        [6, 6, 6, 6, 6, 6, 6, 5, 5, 5, 4, 3] = true →
      completeUpper (n := 12) (pathClosureParallelRounds (n := 12) 4 g) = true := by
  intro g connected degrees
  let g1 := pathClosureParallelRound (n := 12) g
  let g2 := pathClosureParallelRound (n := 12) g1
  let g3 := pathClosureParallelRound (n := 12) g2
  let g4 := pathClosureParallelRound (n := 12) g3
  have closed := connected_degreeSequence_666666655543_closes_closure_chain g g1 g2 g3 g4 connected degrees
