...
theorem connected_degreeSequence_666555555554_closes_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 66,
      connectedUpper (n := 12) g = true →
      fixedDegreeSequenceUpper (n := 12) g
        [6, 6, 6, 5, 5, 5, 5, 5, 5, 5, 5, 4] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_666555555554_closes :
    ∀ g : BitVec 66,
      connectedUpper (n := 12) g = true →
      fixedDegreeSequenceUpper (n := 12) g
        [6, 6, 6, 5, 5, 5, 5, 5, 5, 5, 5, 4] = true →
  ...
  have closed := connected_degreeSequence_666555555554_closes_closure_chain g g1 g2 g3 g4 connected degrees
