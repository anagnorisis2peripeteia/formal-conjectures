...
theorem connected_degreeSequence_55555555543_closure_chain :
    ∀ g g1 g2 g3 g4 : BitVec 55,
      connectedUpper (n := 11) g = true →
      fixedDegreeSequenceUpper (n := 11) g
        [5, 5, 5, 5, 5, 5, 5, 5, 5, 4, 3] = true →
...
set_option maxRecDepth 100000 in
set_option maxHeartbeats 1000000000 in
theorem connected_degreeSequence_55555555543_closes :
    ∀ g : BitVec 55,
      connectedUpper (n := 11) g = true →
      fixedDegreeSequenceUpper (n := 11) g
        [5, 5, 5, 5, 5, 5, 5, 5, 5, 4, 3] = true →
  ...
  have closed := connected_degreeSequence_55555555543_closure_chain g g1 g2 g3 g4 connected degrees
