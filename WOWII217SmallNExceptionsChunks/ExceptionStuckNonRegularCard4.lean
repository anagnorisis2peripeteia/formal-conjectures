...
theorem exception_stuck_non_regular_card4 
  ...
  | 4 =>
have hFinTrans : ∃ G_fin : SimpleGraph (Fin 4), [DecidableRel G_fin.Adj] ∧ G_fin.Connected ∧ G_fin.degreeSequence = G.degreeSequence ∧ (Traceable G_fin → Traceable G) := sorry
