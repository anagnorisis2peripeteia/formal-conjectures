...
/-- Graffiti.pc definition 108: average of eccentricities of vertices in `S`. -/
noncomputable def averageEccentricityOf (G : SimpleGraph α) (S : Finset α) : ℝ :=
  (∑ v ∈ S, (G.eccent v).toNat : ℝ) / (S.card : ℝ)
