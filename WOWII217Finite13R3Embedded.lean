...
/-! Fully canonical `r = 3` certificate using embedded constraint substitution. -/

namespace WOWII217Finite13R3Embedded
...
theorem hasHamiltonianDPState :
    ∀ (g : BitVec 78)
      ...
      (connectedUpper (n := 13) g &&
        ...
        canonicalPermutationBlocksPattern13 g 3 &&
...
end WOWII217Finite13R3Embedded
